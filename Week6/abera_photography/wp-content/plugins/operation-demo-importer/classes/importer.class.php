...
class Wpop_Demo_Importer extends Wpop_Demo_Importer_Abstract {
      ...
      ?>
        <div class="wpop-demo-item <?php echo esc_attr($imported_class); ?>" data-wpop-importer>
          <div class="wpop-demo-screenshot">
            <?php
              $image_url = '';
              $ext_image_url = WPOP_IMPORTER_SCREENSHOT_DIR . $item . '/screenshot.png';
              ...
              } else if($ext_image_url){
                $image_url = WPOP_IMPORTER_SCREENSHOT_DIR . $item . '/screenshot.png';
              }else {
  ...
  /* update customizer data */
    function set_customizer_options() {
      $id = $_POST['id'];
        global $wp_customize;
        $customizer_filepath = WPOP_IMPORTER_CONTENT_DIR . $id . '/customizer.dat';
