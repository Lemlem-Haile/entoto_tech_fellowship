...
define( 'WPOP_IMPORTER_VER' , '1.0.7' );
...
define('WPOP_IMPORTER_SCREENSHOT_DIR', 'https://wpoperation.com/plugin-repo/screenshots/'.get_template().'-demos/');
 ...
 * Load Importer
 */
require_once WPOP_IMPORTER_DIR . '/CustomizerOption.php';
